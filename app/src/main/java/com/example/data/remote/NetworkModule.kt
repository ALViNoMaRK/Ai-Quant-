...
data class ProviderHealth(
    ...
    val circuitState: String = "CLOSED", // "CLOSED", "OPEN", "HALF_OPEN"
    val lastSuccessTime: Long = 0L,
    val lastFailureTime: Long = 0L,
    val errorRatePct: Double = 0.0,
    val rateLimitStatus: String = "OK" // "OK", "EXCEEDED", "COOLDOWN"
)
...
object NetworkModule {
    ...
    val alphaVantageRetrofit: Retrofit = Retrofit.Builder()
