...
data class ScoreBreakdown(
    ...
    val confidenceScore: ConfidenceScore = ConfidenceScore(80, ConfidenceLevel.HIGH, emptyList()),
    val horizonScores: Map<AnalysisHorizon, Double> = emptyMap(),
    val horizonExplanations: Map<AnalysisHorizon, String> = emptyMap(),
    val earningsAwareness: EarningsAwarenessInfo? = null,
