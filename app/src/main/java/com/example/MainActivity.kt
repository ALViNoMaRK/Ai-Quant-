...
enum class MainNavigationItem(val label: String, val icon: ImageVector, val testTag: String) {
    ...
    EVENTS("Events", Icons.Default.Bolt, "nav_events"),
            ...
            if (showOpportunitiesScreen) {
                ...
                when (currentNav) {
                    MainNavigationItem.DASHBOARD -> DashboardScreen(
                        ...
                        onNavigateToEvents = { currentNav = MainNavigationItem.EVENTS }
                    )
                    MainNavigationItem.EVENTS -> MarketEventsScreen(
                        viewModel = viewModel,
                        onNavigateToResearch = { navigateToStockResearch(it) },
...
@androidx.compose.ui.tooling.preview.Preview(showBackground = true, backgroundColor = 0xFF07090E)
@Composable
fun StockIntelAppPreview() {
    MyApplicationTheme(darkTheme = true) {
        Surface(
            modifier = Modifier.fillMaxSize(),
            ...
            Column(
                ...
                Text(
                    text = "Stock Intelligence Platform",
                ...
                Text(
                    text = "Institutional Multi-Factor Equity Terminal",
